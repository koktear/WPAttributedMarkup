...
- (void)viewDidLoad {
    ...
    self.label3.attributedText = [@"Taps  sdfa df adf asdf as dfas dfa  <$$1$$>here</$$1$$> to show help or <settings>here</settings> to show settings" attributedStringWithStyleBook:style3];
